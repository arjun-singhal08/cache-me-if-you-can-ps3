...
Usage: python predict_hybrid.py --input <test_dir> --output <predictions.csv>
"""
import argparse
import sys
import numpy as np
...
def main():
    ...
    parser.add_argument('--model-dir', type=str, default='models_hybrid', help='Model artifacts directory')
